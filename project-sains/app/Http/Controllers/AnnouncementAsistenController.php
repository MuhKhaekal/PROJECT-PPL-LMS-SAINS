...
class AnnouncementAsistenController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.asisten.announcement-asisten', compact('announcements', 'userId', 'name'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('dashboard.asisten.edit-announcement', compact('announcement'));
    }
     ...
     public function update(Request $request, string $id)
{
    ...
    return redirect()->route('announcementasisten.index')->with('success', 'Pengumuman berhasil diubah');
}
    ...
    public function destroy(string $id)
    {
        $announcement = Announcement::findOrFail($id);
        $announcement->delete();    
        return redirect()->route('announcementasisten.index')->with('success', 'Pengumuman berhasil dihapus.');
    }
}
