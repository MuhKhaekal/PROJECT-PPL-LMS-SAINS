...
class PreTestController extends Controller
{
    ...
    public function index()
    {
        ...
        ->get();
        return view('dashboard.asisten.pre-test', compact('students', 'course'));
    }
    ...
    {
        // Ambil data mahasiswa berdasarkan course_id
        ...
        $preTestData = PreTest::whereIn('user_id', $students->pluck('user_id'))
            ->get()
            ->keyBy('user_id'); // Key by student_id for easier lookup

        return view('dashboard.asisten.edit-pre-test', compact('students', 'preTestData', 'courseId' ));
    }
    /**
