...
@section('title', 'SAINS | Edit Tugas')
      ...
      @method('PUT')
        ...
        <div class="space-y-12">
          <div class="border-b border-gray-900/10 pb-12">
            <h2 class="text-base/7 font-semibold text-gray-900">Unggah Tugas</h2>
            <p class="mt-1 text-sm/6 text-gray-600">Silahkan unggah Tugas sesuai dengan minggu pertemuan sekarang ini</p>
      
            <div class=" grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                <div class="col-span-full mt-10">
                    <label for="pertemuan" class="block text-sm/6 font-medium text-gray-900">Nama Tugas</label>
                    <div class="mt-2">
                      <input type="text" name="assignment_name" id="assignment_name" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" placeholder="mis. Ilmu Tajwid" required value="{{ $assignment->assignment_name }}">
