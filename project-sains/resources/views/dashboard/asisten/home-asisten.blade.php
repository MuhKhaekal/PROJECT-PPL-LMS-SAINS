        ...
        <div class="container mx-auto px-4 flex items-center flex-col-reverse md:flex-row">
            <div class="md:flex-1 lg:flex-1" data-aos="fade-right">
                ...
                <div class="m-5 flex flex-col md:flex-row md:m-0 md:mt-5">
                    <a href="{{ route('asisten-group.index') }}" class="px-10 py-3 flex justify-center bg-btn-primary rounded-lg">Lihat Kursus</a>
                    <a href="{{ route('myprofileasisten.index') }}" class="px-10 py-3 flex justify-center text-white ">Lihat Akun Belajar -></a>
                </div>
            </div>
            <div class="md-flex-1 lg:flex-1 flex justify-end" data-aos="fade-left">
                <img src="{{ asset('images/logo-sains.png') }}" alt="" class="size-64 m-8 object-cover lg:size-4/5 shadow-inner ">
            </div>
        </div>
    </header>
