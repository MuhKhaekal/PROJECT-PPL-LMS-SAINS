...
@section('title', 'SAINS - Nilai Per-pekan')
                ...
                <tbody>
                    @foreach ($students as $student)
                        <tr class="border-b">
                            ...
                            <td>
                                <input type="number" name="p1[]" min="10" max="100" class="text-sm rounded-md mx-1 border-gray-200">
                            </td>
                            <td>
                                <input type="number" name="p2[]" min="10" max="100" class="text-sm rounded-md mx-1 border-gray-200">
                            </td>
                            <td>
                                <input type="number" name="p3[]" min="10" max="100" class="text-sm rounded-md mx-1 border-gray-200">
                            </td>
                            <td>
                                <input type="number" name="p4[]" min="10" max="100" class="text-sm rounded-md mx-1 border-gray-200">
                            </td>
                            <td>
                                <input type="number" name="p5[]" min="10" max="100" class="text-sm rounded-md mx-1 border-gray-200">
                            </td>
                            <td>
                                <input type="number" name="p6[]" min="10" max="100" class="text-sm rounded-md mx-1 border-gray-200">
                            </td>
                            <td>
                                <input type="number" name="p7[]" min="10" max="100" class="text-sm rounded-md mx-1 border-gray-200">
                            </td>
                            <td>
                                <input type="number" name="p8[]" min="10" max="100" class="text-sm rounded-md mx-1 border-gray-200">
                            </td>
                            <td>
                                <input type="number" name="p9[]" min="10" max="100" class="text-sm rounded-md mx-1 border-gray-200">
                            </td>
                            <td>
                                <input type="number" name="p10[]" min="10" max="100" class="text-sm rounded-md mx-1 border-gray-200">
                            </td>
                        </tr>
                @endforeach
