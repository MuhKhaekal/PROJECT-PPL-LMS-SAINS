...
<div class="container mx-auto px-4 min-h-screen">
    ...
    <div class="md:flex" data-aos="fade-left"> 
        <div class="flex-1">
            <form class="max-w-lg mx-auto" method="POST" action="{{ route('adminannouncement.store') }}" enctype="multipart/form-data">
                @csrf
               ...
               <div class="flex flex-col w-full max-w-[700px] leading-1.5 p-4 border-gray-500 bg-primary rounded-e-xl rounded-es-xl shadow-2xl drop-shadow-xl">
                  ...
                  <div class="flex items-start my-2.5 bg-gray-600 rounded-xl p-2">
                    ...
                    <div class="flex space-x-5">
                        <a href="{{ route('adminannouncement.edit', ['adminannouncement' => $announcement->id]) }}" class="text-blue-500 hover:text-blue-700 hover:underline">Edit</a>
                        <form action="{{ route('adminannouncement.destroy', ['adminannouncement' => $announcement->id]) }}" method="POST">
                            @csrf
                            @method('DELETE')
